...
const Cards = ({ product }) => {
  return (
    <div className='max-w-screen-2xl mx-auto container  px-4 '>
      <h2 className='text-center  text-4xl p-11 font-bold font-abc'>Elevate Your Style with Our Latest Designs</h2>
      <div className="">
        <Link
          to="/shop"
        ...
        >
          {product.map((item, index) => (
            ...
            >
              ...
              <div className="bg-white font-abc shadow-md rounded-md h-full m-4 relative">
              <p className="font-bold font-abc  absolute top-[1%] shadow-xl left-[4%]  border-gray-400  drop-shadow-2xl shadow-gray-500 transition-transform transform hover:scale-150 text-white text-2xl z-10">{item.category}</p>
                <img
      ...
      <div className='max-w-screen-2xl mx-auto mt-20 container  px-4 py-28 '>
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 '>
                ...
                <p className=' absolute bottom-[50%] font-abc lg:left-5  md:left-10 left-5 text-4xl font-bold z-10 font-serif text-white text-center'>Express Your Personality</p>
                ...
                <p className=' absolute shadow-gray-500   bottom-[50%] font-abc  md:left-[35%] left-11  text-4xl font-bold z-10 font-serif text-white'>Easy Care</p>
                <div className="absolute inset-0 bg-black opacity-20 rounded-xl"></div></Link>
                ...
                <p className='  absolute  bottom-[50%] font-abc  md:left-[35%] left-11  text-4xl font-bold z-10 font-serif text-white   '>Perfect Fit</p>
                <div className="absolute inset-0 bg-black opacity-20 rounded-xl"></div></Link>
              </div>
